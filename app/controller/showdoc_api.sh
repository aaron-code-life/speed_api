...
#
api_key="2567640556facd69797a2c3ea86cca651344341316" #showdoc项目api_key
api_token="575d259ac6cecea4f3621ce635a1fa0d1513233016" #showdoc项目api_token
...
echo -e "\033[32m 当前准备扫描的目录为：${curren_dir} \033[0m "
echo -e "\033[31m  ======= 请确认以上目录，继续请按空格键，不继续你就CTRL+C =======  \033[0m "
read -s -n1 -p "..." # win环境下为照顾用户习惯，停顿一下
